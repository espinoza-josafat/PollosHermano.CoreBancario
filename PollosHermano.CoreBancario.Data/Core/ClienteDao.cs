...
{
    public partial class ClienteDao : IClienteDao
    {
        public async Task<IEnumerable<GetClienteListModel>> GetClienteListAsync()
        {
            ...
            return await dataBase.Connection.QueryAsync<GetClienteListModel>("[dbo].[cspGetClienteList]", commandType: CommandType.StoredProcedure);
        }
    }
}
