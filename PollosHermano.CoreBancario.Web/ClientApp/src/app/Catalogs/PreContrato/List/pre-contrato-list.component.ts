...
import {
    PreContratoService
} from "../../../shared/services/pre-contrato.service";

@Component({
  selector: "app-pre-contrato-list",
  templateUrl: "./pre-contrato-list.component.html",
  styleUrls: [
    "../../../../assets/sass/libs/datatables.scss",
    "./pre-contrato-list.component.scss"
  ],
  encapsulation: ViewEncapsulation.None
})
export class PreContratoListComponent implements OnInit {
