...
import {
    CatTipoCuentaService
} from "../../../shared/services/cat-tipo-cuenta.service";

@Component({
  selector: "app-cat-tipo-cuenta-list",
  templateUrl: "./cat-tipo-cuenta-list.component.html",
  styleUrls: [
    "../../../../assets/sass/libs/datatables.scss",
    "./cat-tipo-cuenta-list.component.scss"
  ],
  encapsulation: ViewEncapsulation.None
})
export class CatTipoCuentaListComponent implements OnInit {
